...
//    functions: IFS<ByteArray, LightVirtualMachine, LightObject> = IFSImpl()
//    extend: LightObject? = null,
//    implements: ArrayList<LightObject> = ArrayList()
//) : IKTSVM<ByteArray, LightVirtualMachine, LightObject>, LightObject(name, LightType.VM, extend, implements, defines, functions) {
//    override val tNULL            = TLightSpecial("null", null)
//    override val tUNDEFINED       = TLightSpecial("undefined", getUndefined())
//    override val tOBJECT          = TLightObject()
//    override val tSTRING          = TLightString(tOBJECT)
//    override val tNUMBER          = TLightNumber(tOBJECT)
//    //
